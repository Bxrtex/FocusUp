      ...
      <div class="schedule-body">
        ...
        <div class="schedule-edit-form">
          ...
          <div class="schedule-inline-grid">
            ...
            ${task.kind === 'birthday'
              ? ''
              : `<input class="priority-select duration-select" id="${editPrefix}-duration" type="number" min="1" step="1" inputmode="numeric" value="${task.durationMinutes || ''}" placeholder="Duration (min)" aria-label="Duration in minutes" />`}
          </div>
          ${task.kind === 'birthday'
            ? ''
            : `<div class="schedule-inline-grid">
