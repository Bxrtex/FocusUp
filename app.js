...
async function initAuth() {
  if (isDemoMode) {
    ...
    document.getElementById('user-name')?.replaceChildren('Demo user');
    document.getElementById('user-avatar')?.replaceChildren('D');
    document.getElementById('mobile-appbar-avatar')?.replaceChildren('D');
    document.getElementById('menu-signout-label')?.replaceChildren('Exit demo');
    document.getElementById('mobile-signout')?.setAttribute('aria-label', 'Exit demo');
    document.querySelector('.signout-btn')?.setAttribute('title', 'Exit demo');
    renderAll();
...
function selectDate(isoDate) {
  ...
  if (document.getElementById('schedule-toggle').checked) document.getElementById('task-date').value = isoDate;
  renderCalendar();
  renderSchedule();
}
